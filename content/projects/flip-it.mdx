...
date: 2019-04-26
published: true
demo: https://flip-it-memory-game.vercel.app/
...
<Gallery config={{iconColor: '#9f9f9f'}} images={[
    ...
    {src: 'https://github.com/tamir-nakar/flip-it-memory-game/blob/master/documentation/server_is_down.jpg?raw=true', description: "Server is down alert in offline mode", type: 'image' },
    {src: '/img/flip-it/flip-it_new_record.jpg', description: "New record",  type: 'image' },
    {src: '/img/flip-it/flip-it_south-park-deck.jpg', description: "South Park deck" ,type: 'image' },  
    {src: '/img/flip-it/flip-it_customizing-deck.jpg', description: "Customizing a deck" ,type: 'image' },  
]} />                       